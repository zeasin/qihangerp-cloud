...
export function getUser(userId) {
  return request({
    url: '/auth-api/system/user/' + parseStrEmpty(userId),
    method: 'get'
  })
}
...
export function getAuthRole(userId) {
  return request({
    url: '/auth-api/system/user/authRole/' + userId,
    method: 'get'
  })
}
...
export function updateAuthRole(data) {
  return request({
    url: '/auth-api/system/user/authRole',
    method: 'put',
    params: data
  })
}
...
//   return request({
//     url: '/auth-api/system/user/deptTree',
//     method: 'get'
//   })
// }
